...
public class WorkshopController {
	...
	public String confirmWorkshopAdding(@RequestParam(value = "workshop_name") String workshopName,
			@RequestParam(value = "workshop_description") String workshopDescription,
